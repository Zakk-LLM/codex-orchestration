...
> **Superseded.** This skill is merged into [dispatch](https://github.com/Zakk-LLM/dispatch) as `--engine codex`; new work goes there. This repository stays as it was so old run directories remain readable (tag `v1-standalone`).
